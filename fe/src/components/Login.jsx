      ...
      <div className="max-w-[1200px] w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="hidden md:flex flex-col justify-center">
          ...
          <p className="font-['Satoshi',sans-serif] text-[18px] text-[rgba(0,0,0,0.6)] leading-[28px] mb-8">
            Chào mừng trở lại! Đăng nhập để tiếp tục mua sắm và trải nghiệm những bộ sưu tập thời trang mới nhất.
          </p>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  className="size-4 rounded border-[rgba(0,0,0,0.3)] text-black focus:ring-black cursor-pointer"
                />
                <span className="ml-2 font-['Satoshi',sans-serif] text-[14px] text-black">
                  Ghi nhớ đăng nhập
                </span>
              </label>
              <button
                type="button"
                className="font-['Satoshi',sans-serif] font-medium text-[14px] text-black underline hover:no-underline"
              >
                Quên mật khẩu?
              </button>
            </div>
